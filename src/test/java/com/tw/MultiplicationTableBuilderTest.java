...
class MultiplicationTableBuilderTest {
    ...
    void should_return_true_when_isStarterNotBiggerThanEnd_given_start_2_end_3() {
        ...
        int end = 3;
        // When
        boolean isValid = multiplicationTableBuilder.isStarterNotBiggerThanEnd(start,end);
    ...
    @Test
    void should_return_false_when_isValid_given_start_0_end_2() {
        // Given
        MultiplicationTableBuilder multiplicationTableBuilder = new MultiplicationTableBuilder();
        int start = 0;
        int end = 2;
    ...
    @Test
    void should_return_false_when_isValid_given_start_2_end_1001() {
        // Given
        MultiplicationTableBuilder multiplicationTableBuilder = new MultiplicationTableBuilder();
        int start = 2;
        int end = 1001;
    ...
    @Test
    void should_return_false_when_isValid_given_start_0_end_1001() {
        // Given
        MultiplicationTableBuilder multiplicationTableBuilder = new MultiplicationTableBuilder();
        int start = 0;
        int end = 1001;
    ...
    @Test
    void should_return_true_expression_when_generateExpression_given_start_2_end_4() {
        // Given
        MultiplicationTableBuilder multiplicationTableBuilder = new MultiplicationTableBuilder();
        int start = 2;
        int end = 4;
